...
void ElaProgressBarStyle::drawControl(ControlElement element, const QStyleOption* option, QPainter* painter,
    ...
    case QStyle::CE_ProgressBarContents: {
      ...
      if (popt->minimum == 0 && popt->maximum == 0) {
        ...
        if (popt->state & QStyle::State_Horizontal) {
          ...
          painter->drawRoundedRect(QRectF(contentRect.x(), contentRect.height() - endValue, contentRect.width(), busyHeight), 3,
                                   3);
        }
      } else {
        ...
        if (popt->state & QStyle::State_Horizontal) {
          ...
          painter->drawRoundedRect(QRectF(contentRect.x(), contentRect.y(), contentRect.width() * ratio, contentRect.height()), 3,
                                   3);
        } else {
