...
ElaNavigationType::NodeOperateReturnType ElaNavigationModel::addPageNode(QString pageTitle, QString& pageKey,
                                                                         ElaIconType::IconName awesome) {
...
QStringList ElaNavigationModel::removeNavigationNode(QString nodeKey) {
  ...
  beginRemoveRows(parentNode->getModelIndex(), parentNode->getChildrenNodes().count() - 1,
