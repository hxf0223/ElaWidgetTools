...
void ElaInteractiveCard::paintEvent(QPaintEvent* event) {
  ...
  if (!d->_pCardPixmap.isNull()) {
    ...
    if (d->_pCardPixMode == ElaCardPixType::PixMode::Ellipse) {
      ...
      painter.drawPixmap(
          QRect(10, (height() - d->_pCardPixmapSize.height()) / 2, d->_pCardPixmapSize.width(), d->_pCardPixmapSize.height()),
      ...
      path.addRoundedRect(
          QRectF(10, (height() - d->_pCardPixmapSize.height()) / 2, d->_pCardPixmapSize.width(), d->_pCardPixmapSize.height()),
