...
class ELA_PACKETIO_EXPORT GenSocket {
 ...
 public:
  ...
  enum ConnectStatus { cCONNECT_IN_PROGRESS, cCONNECT_FAILED, cCONNECT_SUCCESS };
  enum SocketType { cTCP_SOCKET, cUDP_SOCKET };
  enum SocketOptions {
    cNON_BLOCKING = 1,
    cENABLE_BROADCAST = 2,
  ...
  enum WaitAction { cWAITED, cSOCKET_READY, cCAN_NOT_WAIT };
