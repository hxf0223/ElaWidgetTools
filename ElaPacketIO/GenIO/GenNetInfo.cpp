...
void GenNetInfo::Print() {
  ...
  for (int i = 0; i < numInterfaces; ++i) {
    ...
    std::cout << "Interface " << i << ":" << std::boolalpha << "Address: " << interfacePtr->mInfoPtr->mAddr
              << "Broadcast Address: " << interfacePtr->mInfoPtr->mBroadcastAddr
              << "Netmask: " << interfacePtr->mInfoPtr->mNetmask << "Up: " << interfacePtr->mInfoPtr->mIsUp
              << "Point-to-Point: " << interfacePtr->mInfoPtr->mIsPointToPoint
              << "Loopback: " << interfacePtr->mInfoPtr->mIsLoopback << "Has Broadcast: " << interfacePtr->mInfoPtr->mHasBroadcast
              << "Has Multicast: " << interfacePtr->mInfoPtr->mHasMulticast << std::endl;
  }
}
