...
class ELA_PACKETIO_EXPORT GenBuf {
 public:
  enum SeekDirType { FromBeg = 0x01, FromCur = 0x02, FromDataEnd = 0x04, FromPhyEnd = 0x10 };

  enum BufType { BigEndian = 0x01, LittleEndian = 0x02, LittleEndianVax = 0x03, Native = 0x04, Null = 0x05 };
