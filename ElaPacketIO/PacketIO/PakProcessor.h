...
class ELA_PACKETIO_EXPORT PakProcessor {
 public:
  ...
  void RegisterPacket(const std::string& aPacketName, PKT_TYPE* aPktPtr) {
    ...
    PacketInfo* info = RegisterPacketP(PKT_TYPE::cPACKET_ID, aPacketName, new TPacketCallbackList<PKT_TYPE>(), false,
  ...
  void RegisterPacket(int aPacketId, const std::string& aPacketName, PKT_TYPE* aPktPtr, bool aIsUndefined = false) {
    NotAPacketTest(*aPktPtr);
    PacketInfo* info = RegisterPacketP(aPacketId, aPacketName, new TPacketCallbackList<PKT_TYPE>(), aIsUndefined,
                                       PakProcessorDetail::PacketBaseClassId<typename PKT_TYPE::BaseType>::cPACKET_ID);
    DefinePacketFunctions(aPktPtr, info);
    delete aPktPtr;
  }
 ...
 protected:
  PacketInfo* RegisterPacketP(int aPacketId, const std::string aPacketName, PacketCallbackList* aCallbackListPtr,
                              bool aIsUndefined, int aPacketBaseTypeId);
